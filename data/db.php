...
declare(strict_types=1);
  ...
  try {
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS Articles (Article_id INTEGER PRIMARY KEY, Title TEXT, Body TEXT, Author TEXT REFERENCES Users(Full_name) , Dt TIMESTAMP DEFAULT CURRENT_TIMESTAMP, Likes INTEGER)");
